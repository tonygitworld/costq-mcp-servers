...
def parse_complex_param(
    ...
    """解析复杂参数,支持 JSON 字符串和 dict/list 对象.

    Args:
        param: JSON 字符串或 dict/list 对象
...
def parse_float_param(
    ...
    if isinstance(param, (float, int)):
        ...
        try:
            ...
            logger.error(
                "❌ [%s] Invalid float format for %s: %s",
                function_name,
                param_name,
                str(e)
            )
