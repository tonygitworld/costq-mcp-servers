...
from backend.mcp.gcp_cost_mcp_server.constants import DEFAULT_LOOKBACK_DAYS
from backend.mcp.gcp_cost_mcp_server.utils.bigquery_helper import validate_date_range
...
async def get_cud_vs_ondemand_comparison(
    ...
    try:
        ...
        # Pricing analysis
        total_usage_hours = 730 * DEFAULT_LOOKBACK_DAYS / 30  # Approximate hours
        avg_cud_discount = (
