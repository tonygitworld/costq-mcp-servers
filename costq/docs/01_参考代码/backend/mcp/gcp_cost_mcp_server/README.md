...
The server is automatically integrated with the Strands Agent multi-account system:

1. Add GCP account via the web UI
2. Configure BigQuery export settings (project ID, dataset, table name)
3. The server will be available for that account
...
This project is part of the Strands Agent Demo and follows the same license.
