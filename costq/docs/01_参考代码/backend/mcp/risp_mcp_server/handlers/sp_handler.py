...
async def get_savings_plans_utilization(
    context: Context, params: SavingsPlansUtilizationParams
) -> dict[str, Any]:
...
async def get_savings_plans_coverage(
    context: Context, params: SavingsPlansCoverageParams
) -> dict[str, Any]:
...
async def get_savings_plans_purchase_recommendation(
    context: Context, params: SavingsPlansPurchaseRecommendationParams
) -> dict[str, Any]:
...
async def get_savings_plans_utilization_details(
    context: Context, params: SavingsPlansUtilizationDetailsParams
) -> dict[str, Any]:
...
async def get_savings_plan_purchase_recommendation_details(
    context: Context, recommendation_detail_id: str
) -> dict[str, Any]:
