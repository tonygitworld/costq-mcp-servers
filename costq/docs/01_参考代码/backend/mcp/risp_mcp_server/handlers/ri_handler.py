...
async def get_reservation_utilization(
    context: Context, params: ReservationUtilizationParams
) -> dict[str, Any]:
...
async def get_reservation_coverage(
    context: Context, params: ReservationCoverageParams
) -> dict[str, Any]:
...
async def get_reservation_purchase_recommendation(
    context: Context, params: ReservationPurchaseRecommendationParams
) -> dict[str, Any]:
